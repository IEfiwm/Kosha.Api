...
namespace clbModels
{
    ...
    {
        public long insAutoID { get; set; }// شماره ردیف
        ...
        public long DSK_KIND { get; set; }//نوع لیست
        public long DSK_YY { get; set; }//سال عملکرد
        public long DSK_MM { get; set; }// ماه عملکرد
        public string DSK_LISTNO { get; set; }// شماره لیست معمولا همان ماه درج می شود
        public string DSK_DISC { get; set; }// شرح لیست
        public long DSK_NUM { get; set; }// تعداد کارکنان
        public long DSK_TDD { get; set; }// مجموع روزهای کارکرد
        ...
        public long DSK_RATE { get; set; }//نرخ حق بیمه
        public long DSK_PRATE { get; set; }// نرخ پورسانتاژ
    ...
    public partial class SalInsurenceDiskPersonal
    {
        ...
        public long DSW_YY { get; set; }// سال - باید 4 رقمی باشد
        public long DSW_MM { get; set; }// ماه
        ...
        public long DSW_DD { get; set; }// تعداد روزهای کارکرد
        ...
        public long DSW_PRATE { get; set; }// نرخ پورسانت
